...
#### Terraform
With Terraform i am using an [AWS Custom Provider Endpoints](https://github.com/terraform-providers/terraform-provider-openstack/pull/501) feature that allow me to override all the default provider endpoints with my emulated ones. So that is when things start working together.
